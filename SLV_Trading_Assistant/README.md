...
A Python-based research assistant and signal generator for trading the **SLV silver ETF**. The system collects price data, macro-economic indicators, and news headlines, analyses them together, and produces an explainable 11-section research report with a trade signal, confidence score, entry/stop/target levels, and risk warnings.
...
7. [The 11-Section Report](#the-11-section-report)
8. [Trading Style Profiles](#trading-style-profiles)
9. [Data Sources and Tools](#data-sources-and-tools)
10. [Offline Mode](#offline-mode)
11. [Signal History](#signal-history)
12. [Windows Task Scheduler (Automated Daily Runs)](#windows-task-scheduler)
...
```bash
# 1. Clone or copy the SLV_Trading_Assistant folder to your machine.
